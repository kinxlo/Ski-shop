  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-none">
        <CardHeader>
          <h3 className="!text-xl font-semibold md:!text-2xl">Assigned Rider</h3>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
            <div className="flex items-center space-x-3 md:space-x-4">
              ...
              <div>
                <h3 className="!text-lg font-semibold md:!text-xl">{trackingData.rider.name}</h3>
                ...
                <div className="mt-1 flex items-center space-x-1">
                  ...
                  <span className="text-xs text-gray-500">({trackingData.rider.reviews} reviews)</span>
                </div>
              </div>
            </div>
      ...
      <div className="flex space-x-3">
        {canRateRider && (
          <SkiButton variant="primary" onClick={() => setShowRatingModal(true)} className="flex-1">
            Rate Rider
          </SkiButton>
        )}
        {trackingData.currentStatus === "rider_on_way" && (
          <SkiButton variant="primary" onClick={handleDeliverySuccess} className="flex-1">
            Mark as Delivered
          </SkiButton>
        )}
      </div>
