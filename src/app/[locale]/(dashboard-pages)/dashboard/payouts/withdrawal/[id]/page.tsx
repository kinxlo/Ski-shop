          ...
          <div className="mb-6 sm:mb-8">
            ...
            <span
              className={cn(
                ...
                withdrawalData.status === "success" && "bg-green-100 text-green-800",
            ...
            <div className="rounded-lg border border-gray-200 p-4 sm:border-0 sm:p-0">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-yellow-500 sm:h-8 sm:w-8">
                  <span className="text-xs font-bold text-white sm:text-sm">{withdrawalData.bankName.charAt(0)}</span>
                </div>
                <span className="font-medium text-gray-900 sm:text-lg">{withdrawalData.bankName}</span>
              </div>
            </div>
