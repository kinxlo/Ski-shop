...
export const CompletedOrders = () => {
  ...
  const renderEmptyState = () => (
    <EmptyState
      images={[{ src: "/images/empty-state.svg", width: 80, height: 80, alt: "No completed orders" }]}
      title="No completed orders"
      description="There are no completed orders at the moment."
      className="bg-mid-grey-I space-y-0 rounded-lg"
      titleClassName="!text-2xl"
      descriptionClassName="text-base mb-4"
    />
  ...
  const renderCompletedOrdersContent = () => {
    return renderOrdersTable();
  };

  return renderCompletedOrdersContent();
};
