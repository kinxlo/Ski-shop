(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({
        195: "components-shared-logo-Logo-stories",
        241: "components-shared-navbar-Navbar-stories",
        599: "components-shared-breadcrumb-Breadcrumb-stories",
        673: "components-shared-button-Button-stories",
        812: "app-(external-pages)-(home)-_components-shop-card-Shopcard-stories",
        903: "components-shared-inputs-Inputs-stories",
      })[chunkId] || chunkId) +
      "." +
      {
        179: "6d263ad2",
      ...
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (var scripts = document.getElementsByTagName("script"), i = 0; i < scripts.length; i++) {
            var s = scripts[i];
            if (s.getAttribute("src") == url || s.getAttribute("data-webpack") == "tsa-app:" + key) {
              script = s;
              break;
            }
          }
        script ||
          ...
          script.setAttribute("data-webpack", "tsa-app:" + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunktsa_app = self.webpackChunktsa_app || []);
