try {
  (() => {
    ...
    var K = { type: "item", value: "" },
      U = (r, t) => ({
        ...
        toolbar: {
          ...
          items: t.toolbar.items.map((e) => {
            ...
            return (
              o.type === "reset" && t.toolbar.icon && ((o.icon = t.toolbar.icon), (o.hideIcon = !0)), { ...K, ...o }
            );
          }),
        },
      }),
      ...
      W = ({ currentValue: r, items: t }) => r != null && t.find((e) => e.value === r && e.type !== "reset"),
      ...
      Q = ({ right: r, title: t, value: e, icon: o, hideIcon: a, onClick: c, disabled: _, currentValue: i }) => {
        let l = o && n.createElement(A, { style: { opacity: 1 }, icon: o, __suppressDeprecationWarning: !0 }),
    ...
    k.register(S, () =>
      k.add(S, { title: S, type: M.TOOL, match: ({ tabId: r }) => !r, render: () => n.createElement(ee, null) }),
    );
  })();
} catch (e) {
