  ...
  (() => {
    ...
    function Mr(e, t, n) {
      ...
      return (
        r.forEach(function (o) {
          ...
          o.enabled &&
            Rr(i) &&
            ((t.offsets.popper = xe(t.offsets.popper)), (t.offsets.reference = xe(t.offsets.reference)), (t = i(t, o)));
        }),
        t
      );
    }
    ...
    function zt(e, t) {
      Object.keys(t).forEach(function (n) {
        var r = "";
        ["width", "height", "top", "right", "bottom", "left"].indexOf(n) !== -1 && Zt(t[n]) && (r = "px"),
          (e.style[n] = t[n] + r);
      });
    }
    function gi(e, t) {
    ...
    function Ri(e) {
      var t = e.offsets,
        ...
        l = a ? "width" : "height";
      return (
        n[s] < i(r[c]) && (e.offsets.popper[c] = i(r[c]) - n[l]), n[c] > i(r[s]) && (e.offsets.popper[c] = i(r[s])), e
      );
    }
    function Ci(e, t, n, r) {
      var o = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/),
    ...
    function Ta(e, t, n) {
      ...
      return (
        i instanceof HTMLElement &&
          ((s = i.scrollTop), !a && !ot(e) && (c += s), i.isSameNode(je()) || (c += je().scrollTop)),
        Math.floor(c - t)
      );
    }
    function Ia(e, t, n) {
    ...
    function ja(e, t) {
      ...
      window.innerWidth > 480 && (f = 380),
        "width" in u &&
          (f = typeof u.width == "number" && window.innerWidth < u.width ? window.innerWidth - 30 : u.width);
      let h = { bottom: 0, left: 0, overflow: "hidden", position: "absolute", right: 0, top: 0, zIndex: u.zIndex },
        b = {
          ...
          floaterStyles: {
            arrow: {
              color:
                (a = (i = (o = l?.styles) == null ? void 0 : o.arrow) == null ? void 0 : i.color) != null
                  ? a
                  : u.arrowColor,
            },
    ...
    function Va(e) {
      ...
      return (
        ...
        v &&
          ...
          (H.skip = q(
            "button",
            { "aria-live": "off", "data-test-id": "button-skip", style: T.buttonSkip, type: "button", ...c },
            V,
          )),
        !d &&
          o > 0 &&
          (H.back = q("button", { "data-test-id": "button-back", style: T.buttonBack, type: "button", ...t }, g)),
        ...
        q(
          ...
          !h &&
            q("div", { style: T.tooltipFooter }, q("div", { style: T.tooltipFooterSpacer }, H.skip), H.back, H.primary),
          H.close,
        )
      );
    }
        ...
        ae(
          () =>
            e.on(un, ({ payload: P, success: V }) => {
              !V ||
                !P?.newStoryName ||
                (h(P), o(!0), a("5:StoryCreated"), setTimeout(() => e.clearNotification("save-story-success")));
            }),
          [e],
        ),
              ...
              g &&
                y.createElement(
                  ...
                  y.createElement(
                    Ss,
                    null,
                    y.createElement(mn, { language: "jsx", showLineNumbers: !0, startingLineNumber: O }, g),
                  ),
                ),
            ),
            offset: 12,
        ...
        (po = Object.create),
          ...
          (yo = (e, t, n, r) => {
            if ((t && typeof t == "object") || typeof t == "function")
              for (let o of br(t))
                !mo.call(e, o) && o !== n && gr(e, o, { get: () => t[o], enumerable: !(r = fo(t, o)) || r.enumerable });
            return e;
          }),
          (De = (e, t, n) => (
            (n = e != null ? po(ho(e)) : {}),
              ...
              function N(m, g, O) {
                ...
                return (
                  ...
                  f(g).forEach(function (P) {
                    b(m, P) ||
                      (h(m, P) && O.isMergeableObject(g[P]) ? (B[P] = u(P, O)(m[P], g[P], O)) : (B[P] = l(g[P], O)));
                  }),
                  B
                );
              }
              ...
              t.exports = function (l, p) {
                ...
                function O(E) {
                  function x(W, D, L, z, M) {
                    if (typeof E != "function")
                      return new v(
                        "Property `" + M + "` of component `" + L + "` has invalid PropType notation inside arrayOf.",
                      );
                    var F = W[D];
                    if (!Array.isArray(F)) {
                      var G = he(F);
                ...
                function te(E) {
                  function x(W, D, L, z, M) {
                    if (typeof E != "function")
                      return new v(
                        "Property `" + M + "` of component `" + L + "` has invalid PropType notation inside objectOf.",
                      );
                    var F = W[D],
                      G = he(F);
                    if (G !== "object")
                ...
                function Ne(E) {
                  if (!Array.isArray(E))
                    return s("Invalid argument supplied to oneOfType, expected an instance of array."), c;
                ...
                function Ve() {
                  function E(x, W, D, L, z) {
                    return Te(x[W])
                      ? null
                      : new v("Invalid " + L + " `" + z + "` supplied to " + ("`" + D + "`, expected a ReactNode."));
                  }
                  return T(E);
                }
...
Valid keys: ` +
        ...
        I.domElement = (e) =>
          I.object(e) && !I.plainObject(e) && e.nodeType === 1 && I.string(e.nodeName) && Vo.every((t) => t in e);
        I.empty = (e) =>
            ...
            ct(n, [
              {
                ...
                value: function () {
                  ...
                  return d
                    ? y.createElement(
                        "span",
                        { ref: l, style: J(J({}, u), p), onClick: i, onMouseEnter: a, onMouseLeave: s },
                        d,
                      )
                    : null;
                },
        ...
        (ga = De(To(), 1)),
          ...
          (va = (e, t, n) =>
            t in e ? ba(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)),
            ...
            constructor(e) {
              _(this, "beaconPopper"),
                ...
                _(this, "close", (o = null) => {
                  ...
                  a === j.RUNNING &&
                    this.setState({ ...this.getNextState({ action: $.CLOSE, index: i + 1, origin: o }) });
                }),
                _(this, "go", (o) => {
            ...
            constructor(e, t) {
              if (
                ...
                _(this, "canHaveFocus", (n) => {
                  ...
                  return (
                    ((r.test(o) && !n.getAttribute("disabled")) || (o === "a" && !!n.getAttribute("href"))) &&
                    this.isVisible(n)
                  );
                }),
          ...
          (Ja = class extends Le {
            ...
            render() {
              ...
              if (s) {
                ...
                l = q(Ka, { ...this.getElementsProps(), continuous: e, index: t, isLastStep: n, size: o, step: i });
              return l;
            }
          }),
          (Xa = class extends Le {
    ...
    fn.register("@storybook/addon-onboarding", async (e) => {
      ...
      e.once(pn, () => {
        ...
        (r.id = "storybook-addon-onboarding"),
          ...
          Me.render(
            y.createElement(rn, { fallback: y.createElement("div", null) }, y.createElement(Ts, { api: e })),
            r,
          );
      });
    });
