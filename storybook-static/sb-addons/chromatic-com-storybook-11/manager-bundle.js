  ...
  (() => {
    ...
    var qr = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
      ...
      mc = (e, t, n, r) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let i of sc(t))
            !dc.call(e, i) && i !== n && Wr(e, i, { get: () => t[i], enumerable: !(r = oc(t, i)) || r.enumerable });
        return e;
      };
    var Gl = (e, t, n) => (
      (n = e != null ? lc(cc(e)) : {}),
    ...
    var Se,
      ae = Gr(() => {
        Se = {
          NODE_ENV: "production",
          NODE_PATH: [
            "C:\\Users\\LENOVO\\Documents\\projects\\javascript\\next\\Skicom\\Ski-shop\\node_modules\\.pnpm\\storybook@8.6.12_prettier@3.4.2\\node_modules\\storybook\\bin\\node_modules",
    ...
    var vo = qr((bv, go) => {
      ...
      var Oa = {
          ...
          return (
            ...
            e === 0
              ...
              : (e /= r) === 1
                ? t + i
                : (o || (o = r * 0.3),
                  l < Math.abs(i) ? ((l = i), (s = o / 4)) : (s = (o / (2 * Math.PI)) * Math.asin(i / l)),
                  -(l * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * r - s) * (2 * Math.PI)) / o)) + t)
          );
        },
            ...
            e === 0
              ...
              : (e /= r / 2) === 2
                ...
                : (o || (o = r * 0.44999999999999996),
                  l < Math.abs(i) ? ((l = i), (s = o / 4)) : (s = (o / (2 * Math.PI)) * Math.asin(i / l)),
                  e < 1
                    ? -0.5 * (l * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * r - s) * (2 * Math.PI)) / o)) + t
                    : l * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * r - s) * (2 * Math.PI)) / o) * 0.5 + i + t)
          );
        },
        ...
        easeOutBack: function (e, t, n, r, i) {
          var l = n - t;
          return i === void 0 && (i = 1.70158), l * ((e = e / r - 1) * e * ((i + 1) * e + i) + 1) + t;
        },
    ...
    function ti(
      ...
      let E = g,
        ...
        b = 0,
        C = dn;
      m === Rd ? ((r = 10), (m = Xr)) : m === oo || m === Xr ? (r = 2) : r === 2 ? (m = oo) : ((r = 10), (m = Xr));
      let O = r === 10 ? 1e3 : 1024,
        I = p === !0,
        U = h < 0,
        G = Math[y];
    ...
    var $d = 1e3 / 60,
        ...
        update(t) {
          ...
          (this.x += this.vx * s),
            ...
            this.rotateY >= 1 && this.rotationDirection === Ot.Positive
              ...
              : this.rotateY <= -1 && this.rotationDirection === Ot.Negative && (this.rotationDirection = Ot.Positive);
          ...
          (this.x = 0),
            ...
            (this.animate = (i) => {
              ...
              let y = this.particles.length,
                k = m ? y : s;
              if (k < u) {
                c !== u && ((this.tweenProgress = 0), (this.tweenFrom = k), (this.lastNumberOfPieces = u)),
              ...
              for (let E = this.particles.length - 1; E >= 0; E--) {
                ...
                h.update(i),
                  (h.y > l.height || h.y < -100 || h.x > l.width + 100 || h.x < -100) &&
                    (m && k <= u ? (this.particles[E] = this.getParticle()) : this.removeParticleAt(E));
              }
              return y > 0 || k < u;
            }),
            (this.canvas = t);
            ...
            (this.update = (i = 0) => {
              ...
              (this.lastFrameTime = i - (s ? m % s : 0)),
                ...
                this.generator.animate(m)
                  ? (this.rafId = requestAnimationFrame(this.update))
                  : (o && typeof o == "function" && this.generator.particlesGenerated > 0 && o.call(this, this),
                    (this._options.run = !1));
            }),
            (this.reset = () => {
              this.generator &&
      ...
      Bn = class extends a.Component {
        ...
        render() {
          ...
          return (0, li.jsx)("canvas", { width: t.width, height: t.height, ref: this.canvas, ...n, style: r });
        }
      };
    Bn.defaultProps = { ...oi };
    ...
    var qd = Object.create,
      ...
      Xd = ((e) =>
        typeof Dt < "u" ? Dt : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof Dt < "u" ? Dt : t)[n] }) : e)(
        function (e) {
      ...
      e5 = (e, t, n, r) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let i of Qd(t))
            !Jd.call(e, i) && i !== n && ts(e, i, { get: () => t[i], enumerable: !(r = Yd(t, i)) || r.enumerable });
        return e;
      },
      et = (e, t, n) => (
        (n = e != null ? qd(Kd(e)) : {}),
      ...
      dl = Vt((e, t) => {
        ...
        function y(v, b) {
          return g(v, b) && !(Object.hasOwnProperty.call(v, b) && Object.propertyIsEnumerable.call(v, b));
        }
        function k(v, b, C) {
          var O = {};
          return (
            ...
            f(b).forEach(function (I) {
              y(v, I) || (g(v, I) && C.isMergeableObject(b[I]) ? (O[I] = u(I, C)(v[I], b[I], C)) : (O[I] = d(b[I], C)));
            }),
            O
          );
        }
      ...
      _5 = w.span(({ theme: e }) => ({ color: e.base === "light" ? e.color.defaultText : e.color.light })),
      ...
      V5 = W(({ color: e = "currentColor", size: t = 14, ...n }, r) =>
        S(
          ...
          S("path", { d: "M4.5 4a.5.5 0 00-.5.5v5a.5.5 0 00.5.5h5a.5.5 0 00.5-.5v-5a.5.5 0 00-.5-.5h-5z", fill: e }),
          S("path", {
            fillRule: "evenodd",
            clipRule: "evenodd",
      ...
      os = W(({ color: e = "currentColor", size: t = 14, ...n }, r) =>
        S(
          ...
          S("path", { d: "M8 8.004a1 1 0 01-.5.866v1.634a.5.5 0 01-1 0V8.87A1 1 0 118 8.004z", fill: e }),
          S("path", {
            fillRule: "evenodd",
            clipRule: "evenodd",
      ...
      Q5 = W(({ color: e = "currentColor", size: t = 14, ...n }, r) =>
        S(
          ...
          S(
            "defs",
            null,
            S("clipPath", { id: "prefix__clip0_1449_588" }, S("path", { fill: "#fff", d: "M0 0h14v14H0z" })),
          ),
        ),
      ),
                  ...
                  (function (c) {
                    ...
                    c((m) => {
                      if (m === 0) {
                        if (r.length) {
                          var u = r.indexOf(d);
                          u > -1 && (r = r.slice()).splice(u, 1), r.length || (o ? n(0) : l || ((l = !0), i(0)));
                        }
...
`),
        ...
        (La.lastIndex = 0),
          La.test(t[o]) && (o && (!r || La.lastIndex < r) && (r = La.lastIndex), (i = i || o), (l = o));
      for (var s = i; s <= l; s++)
        s !== i &&
          (n += `
`),
    ...
    function Xa(e) {
      var t, n;
      if ((n = ze(hu))) t = n === "null" ? { kind: "NullValue" } : { kind: "BooleanValue", value: n === "true" };
      else if (!e && (n = ze(vs))) t = { kind: "Variable", name: { kind: "Name", value: n.slice(1) } };
      else if ((n = ze(fu))) {
        var r = n;
        (n = ze(gu)) ? (t = { kind: "FloatValue", value: r + n }) : (t = { kind: "IntValue", value: r });
      } else if ((n = ze(gs))) t = { kind: "EnumValue", value: n };
      else if ((n = ze(yu))) t = { kind: "StringValue", value: pu(n.slice(3, -3)), block: !0 };
      else if ((n = ze(Eu))) t = { kind: "StringValue", value: vu.test(n) ? JSON.parse(n) : n.slice(1, -1), block: !1 };
      else if (
        (t =
          (function (i) {
            var l;
    ...
    function bu() {
      ...
      if (e) {
        ...
        return { kind: "Field", alias: t, name: e, arguments: ys(!1), directives: bn(!1), selectionSet: Tr() };
      }
    }
    function Es() {
      var e;
    ...
    function Cu() {
      if (ze(wu)) {
        ...
        var e = Y,
          t;
        if ((t = vt()) && t.value !== "on") return { kind: "FragmentSpread", name: t, directives: bn(!1) };
        Y = e;
        var n = bs(),
          r = bn(!1),
          i = Tr();
        ...
        (n = (function () {
          ...
          if ((J(), fe.charCodeAt(Y) === 40)) {
            for (Y++, J(); (l = ze(vs)); ) {
              ...
              var s = Es(),
                c = void 0;
              if (fe.charCodeAt(Y) === 61 && (Y++, J(), !(c = Xa(!0)))) throw Ce("VariableDefinition");
              J(),
                o.push({
        ...
        OperationDefinition(e) {
          ...
          return (
            ...
            Ye(e.variableDefinitions) &&
              (e.name || (t += " "), (t += "(" + e.variableDefinitions.map(Ae.VariableDefinition).join(", ") + ")")),
...
# ${n}`,
      ...
      ks = (e) => {
        for (var t of e.definitions) if (t.kind === mu.OPERATION_DEFINITION) return t.name ? t.name.value : void 0;
      },
      To = (e, t, n) => {
      ...
      Zu = (e, t, n, r) => {
        ...
        if (s) {
          var d = function (u) {
            Array.isArray(u.errors) && i.push(...u.errors), u.extensions && (Object.assign(o, u.extensions), (l = !0));
            var p = "data",
              f = c,
              g = [];
            if (u.path) g = u.path;
            ...
            for (var k = 0, E = g.length; k < E; p = g[k++]) f = f[p] = Array.isArray(f[p]) ? [...f[p]] : { ...f[p] };
            if (u.items)
              for (var h = +p >= 0 ? p : 0, v = 0, b = u.items.length; v < b; v++) f[h + v] = Di(f[h + v], u.items[v]);
    ...
    function Bu(e) {
      return {
        query: e.extensions && e.extensions.persistedQuery && !e.extensions.persistedQuery.miss ? void 0 : bl(e.query),
...
`,
        ...
        if (!r) throw m;
        yield ws(e, l && (l.status < 200 || l.status >= 300) && l.statusText ? new Error(l.statusText) : m, l);
      }
    }
    function $u(e, t, n) {
      var r;
      ...
      Gu =
        ...
        (n) => {
          var r = Ka((l) => {
              ...
              return d;
            })(Ve((l) => l.kind !== "teardown" && (l.kind !== "subscription" || !!l.context.fetchSubscriptions))(n)),
            i = e(Ve((l) => l.kind === "teardown" || (l.kind === "subscription" && !l.context.fetchSubscriptions))(n));
          return ta([r, i]);
        },
      qu =
        (e) =>
            ...
            var v = ms(Ve((b) => b.kind === "teardown" && b.key === h.key)(c.source))(
              Ve(
                (b) =>
                  ...
                  (!b.operation.context._instance || b.operation.context._instance === h.context._instance),
              )(E),
            );
            return (
              ...
              h.kind !== "query"
                ...
                : (v = So((b) => {
                    ...
                    return b.stale || b.hasNext
                      ? C
                      : ta([C, Ri(() => ((b.stale = !0), b))(_r(1)(Ve((O) => O.key === h.key)(c.source)))]);
                  })(v)),
              h.kind !== "mutation"
                ? (v = vl(() => {
              ...
              .then(() =>
                e({
                  mutate(E, h, v) {
                    ...
                    return yl(
                      _r(1)(
                        Ve((C) => C.operation.key === b.key && b.context._instance === C.operation.context._instance)(
                          Ii(() => {
                            var C = g(b);
                  ...
                  appendHeaders(E, h) {
                    var v =
                      typeof E.context.fetchOptions == "function"
                        ...
                        : E.context.fetchOptions || {};
                    return ar(E.kind, E, { ...E.context, fetchOptions: { ...v, headers: { ...v.headers, ...h } } });
                  },
                }),
              )
              .then((E) => {
                  ...
                  : E.context._instance && r.has(E.context._instance)
                    ...
                    : E.context.authAttempt
                      ...
                      : d || !m
                        ...
                        : (function (h) {
                              return !h.context.authAttempt && m && m.willAuthError && m.willAuthError(h);
                            })(E)
                          ? (f(E), null)
                          : g(ui(E, !1)),
              )(ta([i.source, u])),
          ...
          return ta([
            ...
            Ve((E) =>
              ...
              !E.operation.context.authAttempt
                ? (f(E.operation), !1)
                : (r.has(E.operation.context._instance) && r.delete(E.operation.context._instance), !0),
            )(k),
          ]);
        };
      };
    ...
    var kl = () => {
      ...
      ji = { fetching: !1, stale: !1, error: void 0, data: void 0, extensions: void 0, operation: void 0 },
    ...
    var Cl = () => {
      ...
      m2 = u2(),
      Ss = (e) => ({
        headers: { Accept: "*/*", ...(e && { Authorization: `Bearer ${e}` }), "X-Chromatic-Session-ID": m2 },
      }),
      xs = (e) =>
        new Ku({
          url: s5,
    ...
    var xl = () => {
      ...
      f2 = { buildProgressPercentage: 0, currentStep: Ui[0], stepProgress: Object.fromEntries(Ui.map((e) => [e, {}])) };
    JSON.stringify(f2);
    var j = w.div(
    ...
    function O2(e, t, n) {
      ...
      if (typeof e == "object" && t === void 0 && n === void 0) return or(e.hue, e.saturation, e.lightness);
      throw new mt(1);
    }
    function L2(e, t, n, r) {
    ...
    function qi(e, t, n) {
      if (typeof e == "number" && typeof t == "number" && typeof n == "number") return Gi("#" + Wt(e) + Wt(t) + Wt(n));
      if (typeof e == "object" && t === void 0 && n === void 0) return Gi("#" + Wt(e.red) + Wt(e.green) + Wt(e.blue));
      throw new mt(6);
    }
    function Yi(e, t, n, r) {
    ...
    ue({
      ...
      "&:active, &.__active": { borderColor: `${Yi(V.secondary, 1)}`, transform: "translate3d(0, 0, 0)" },
    });
    ...
    ue({ fontSize: 14, fontWeight: P.weight.extrabold, lineHeight: "18px", letterSpacing: "0.38em" }),
      ue({ fontSize: 11, fontWeight: P.weight.extrabold, lineHeight: "16px", letterSpacing: "0.38em" });
    ...
    ue({ fontFamily: P.type.code, fontSize: P.size.s2, fontWeight: P.weight.regular, lineHeight: "17px" }),
      ue({ fontFamily: P.type.code, fontSize: P.size.s1, fontWeight: P.weight.regular, lineHeight: "14px" });
    ...
    var j2 = ue({
      ...
      Vs = w(_l)(({ theme: e }) => ({ background: e.color.secondary, transition: "width 3s ease-out" })),
          ...
          return a.createElement(
            we,
            {
              ...
              tooltip: a.createElement(
                tm,
                null,
                a.createElement("div", null, a.createElement(Ml, { localBuildProgress: i, small: !0, withEmoji: !0 })),
                a.createElement(_l, null, typeof d == "number" && a.createElement(Vs, { style: { width: `${d}%` } })),
                t &&
                  a.createElement(
                    am,
                    null,
            ...
            a.createElement(
              ...
              a.createElement(vi, { xmlns: "http://www.w3.org/2000/svg" }, a.createElement("circle", null)),
              a.createElement(
                vi,
        ...
        return n
          ...
          : a.createElement(
              we,
              {
                trigger: "hover",
                hasChrome: !1,
                tooltip: a.createElement(_e, { note: "No code changes detected. Rerun tests to take new snapshots." }),
              },
              a.createElement(
                Vn,
                { id: "button-run-tests", "aria-label": "Run tests", onClick: () => s() },
      ...
      hm = w.a(
        ...
        (e) => ({
          ...
          ...(e.tertiary && { color: V.dark, "&:hover": { color: V.darkest }, "&:active": { color: V.mediumdark } }),
          ...(e.nochrome && {
            color: "inherit",
            "&:hover, &:active": { color: "inherit", textDecoration: "underline" },
          }),
          ...(e.inverse && { color: V.lightest, "&:hover": { color: V.lighter }, "&:active": { color: V.light } }),
        }),
      ),
      fm = w.a({}),
      gm = w.button({ background: "none", border: "none", padding: "0", font: "inherit", cursor: "pointer" }),
      Hs = W(({ inverse: e, isButton: t, LinkWrapper: n, nochrome: r, secondary: i, tertiary: l, ...o }, s) =>
        t
    ...
    Ie.displayName = "Link";
    Ie.defaultProps = { withArrow: !1, isButton: !1, secondary: !1, tertiary: !1, nochrome: !1, inverse: !1 };
    var vm = w.label((e) => ({
    ...
    var Nm = w.div(
        ...
        (e) => ({
          ...
          ...(e.inline && {
            ...
            ...(e.negative && { borderTopColor: V.red, borderLeftColor: V.red, borderRightColor: V.red }),
            ...(e.neutral && { borderTopColor: V.dark, borderLeftColor: V.dark, borderRightColor: V.dark }),
            ...(e.inverse && { borderTopColor: V.lightest, borderLeftColor: V.lightest, borderRightColor: V.lightest }),
          }),
        }),
      ),
      Qi = (e) =>
        a.createElement(Nm, { "aria-label": "Content is loading ...", "aria-live": "polite", role: "status", ...e }),
      Mm = function (e) {
        var t = new WeakMap();
        return function (n) {
          if (t.has(n)) return t.get(n);
      ...
      Rm = w.span(Ol),
      Im = Mm((e) => w(({ active: t, isLoading: n, activeColor: r, ...i }) => a.createElement(e, { ...i }))(Ol)),
      tt = ({
          ...
          var k = g[n - 15],
            ...
            b =
              ...
              (g[n] =
                n < 16
                  ? g[n]
                  : (g[n - 16] + (t(k, 7) ^ t(k, 18) ^ (k >>> 3)) + g[n - 7] + (t(E, 17) ^ t(E, 19) ^ (E >>> 10))) | 0);
          (d = [(b + ((t(h, 2) ^ t(h, 13) ^ t(h, 22)) + ((h & d[1]) ^ (h & d[2]) ^ (d[1] & d[2])))) | 0].concat(d))[4] =
            (d[4] + b) | 0;
        }
    ...
    var Zm = (e) => new Uint8Array(e).reduce((t, n) => t + String.fromCharCode(n), ""),
      ...
      zm = async ({ expires: e, device_code: t, verifier: n }) => {
        ...
        try {
          ...
          if (Dm(r)) throw new Error("You have not authorized the Visual Tests addon for Chromatic, please try again");
    ...
    var Ws = qe(void 0),
      ...
      Uo = w.div(({ theme: e }) => ({ display: "flex", flexGrow: 1, flexWrap: "wrap", gap: "5px 10px" })),
      $o = w.div(({ theme: e }) => ({
        fontWeight: e.typography.weight.bold,
      ...
      Go = w.div(({ theme: e }) => ({ color: e.base === "dark" ? e.color.medium : e.color.dark, marginTop: 2 })),
      ...
      u4 = ({ children: e, initialState: t = Qs }) => {
        let [n, r] = Xl(d4, t);
        return a.createElement(Ks.Provider, { value: n }, a.createElement(Js.Provider, { value: r }, e));
      },
      ...
      ia = ({ children: e, links: t, note: n, ...r }) => {
            ...
            we,
            {
              ...
              tooltip: ({ onHide: s }) =>
                a.createElement(
                  m4,
                  null,
                  a.createElement(no, { links: t.map((c) => ({ ...c, onClick: (...d) => (s(), c.onClick?.(...d)) })) }),
                ),
              trigger: "click",
              ...r,
            },
        ...
        return n
          ? a.createElement(we, { tooltip: a.createElement(_e, { note: n }), trigger: "hover", hasChrome: !1 }, o)
          : o;
      },
      Rr = () => {
    ...
    var p4 = w.div(
      ...
      g4 = w(Xn)(({ theme: e }) => ({ background: e.background.hoverable, color: e.color.defaultText })),
      v4 = ({ hidden: e, ignoreConfig: t, ignoreSuggestions: n, onOpen: r }) => {
        let [i] = Ee(Ar),
          ...
          m = a.createElement(Ie, { isButton: !0, onClick: () => r(l[0] || o[0]), withArrow: !0 }, "Show details");
        return l.length > 0 && !t
          ? a.createElement(
              f4,
              { hidden: e },
          ...
          : o.length > 0 && !s && !t && !n
            ? a.createElement(
                ...
                a.createElement(
                  Yo,
                  null,
                  a.createElement(Xe, null, a.createElement("span", null, "Configuration could be improved. ", m)),
                  a.createElement(Xe, { push: !0 }, a.createElement(Je, { onClick: d }, a.createElement(fl, null))),
                ),
              )
            : null;
      },
      ...
      k4 = ({ value: e, placeholder: t, suffix: n }) =>
        a.createElement(b4, null, a.createElement("span", null, e || t), a.createElement("b", null, n)),
      ...
      Zr = ({ onBack: e }) =>
        a.createElement(
          h4,
          null,
          e && a.createElement(Xe, null, a.createElement(Ko, { onClick: e }, a.createElement(K5, null), "Back")),
          a.createElement(
            Xe,
            { push: !0 },
            a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                yt,
                null,
                a.createElement(ce, { variant: "solid", size: "medium", onClick: () => t() }, "Sign in with Chromatic"),
    ...
    var la = (e, t) => {
        ...
        switch (e.code) {
          case x.invalid_type:
            e.received === M.undefined ? (n = "Required") : (n = `Expected ${e.expected}, received ${e.received}`);
            break;
    ...
    var Q = class {
        ...
        _refinement(e) {
          return new rt({ schema: this, typeName: D.ZodEffects, effect: { type: "refinement", refinement: e } });
        }
        superRefine(e) {
        ...
        default(e) {
          ...
          return new ga({ ...$(this._def), innerType: this, defaultValue: t, typeName: D.ZodDefault });
        }
        brand() {
    ...
    var pt = class extends Q {
      _parse(e) {
        ...
        for (let r of this._def.checks)
          if (r.kind === "min")
            ...
            e.data.length > r.value &&
              ((n = this._getOrReturnCtx(e, n)),
              T(n, { code: x.too_big, maximum: r.value, type: "string", inclusive: !0, exact: !1, message: r.message }),
              t.dirty());
                    ...
                    : r.kind === "toUpperCase"
                      ...
                      : r.kind === "startsWith"
                        ? e.data.startsWith(r.value) ||
                          ((n = this._getOrReturnCtx(e, n)),
                          T(n, { code: x.invalid_string, validation: { startsWith: r.value }, message: r.message }),
                          t.dirty())
                        : r.kind === "endsWith"
                          ? e.data.endsWith(r.value) ||
                            ((n = this._getOrReturnCtx(e, n)),
                            T(n, { code: x.invalid_string, validation: { endsWith: r.value }, message: r.message }),
                            t.dirty())
                          : r.kind === "datetime"
                            ? V4(r).test(e.data) ||
                              ((n = this._getOrReturnCtx(e, n)),
                              T(n, { code: x.invalid_string, validation: "datetime", message: r.message }),
                              t.dirty())
                            : r.kind === "ip"
                              ? D4(e.data, r.version) ||
                                ((n = this._getOrReturnCtx(e, n)),
                                T(n, { validation: "ip", code: x.invalid_string, message: r.message }),
                                t.dirty())
                              : le.assertNever(r);
        return { status: t.value, value: e.data };
      }
      _regex(e, t, n) {
        return this.refinement((r) => e.test(r), { validation: t, code: x.invalid_string, ...B.errToObj(n) });
      }
      _addCheck(e) {
      ...
      includes(e, t) {
        return this._addCheck({ kind: "includes", value: e, position: t?.position, ...B.errToObj(t?.message) });
      }
      startsWith(e, t) {
    ...
    var Jt = class extends Q {
        ...
        for (let r of this._def.checks)
          r.kind === "int"
            ? le.isInteger(e.data) ||
              ...
              T(t, { code: x.invalid_type, expected: "integer", received: "float", message: r.message }),
              n.dirty())
            : r.kind === "min"
                ...
                : r.kind === "multipleOf"
                  ...
                  : r.kind === "finite"
                    ? Number.isFinite(e.data) ||
                      ((t = this._getOrReturnCtx(e, t)), T(t, { code: x.not_finite, message: r.message }), n.dirty())
                    : le.assertNever(r);
      ...
      safe(e) {
        ...
        })._addCheck({ kind: "max", inclusive: !0, value: Number.MAX_SAFE_INTEGER, message: B.toString(e) });
      }
      get minValue() {
        let e = null;
        for (let t of this._def.checks) t.kind === "min" && (e === null || t.value > e) && (e = t.value);
      ...
      _parse(e) {
        ...
        for (let r of this._def.checks)
          r.kind === "min"
            ? (r.inclusive ? e.data < r.value : e.data <= r.value) &&
              ((t = this._getOrReturnCtx(e, t)),
              T(t, { code: x.too_small, type: "bigint", minimum: r.value, inclusive: r.inclusive, message: r.message }),
              n.dirty())
            : r.kind === "max"
              ? (r.inclusive ? e.data > r.value : e.data >= r.value) &&
                ((t = this._getOrReturnCtx(e, t)),
                T(t, { code: x.too_big, type: "bigint", maximum: r.value, inclusive: r.inclusive, message: r.message }),
                n.dirty())
              : r.kind === "multipleOf"
        ...
        for (let r of this._def.checks)
          r.kind === "min"
            ? e.data.getTime() < r.value &&
              ((n = this._getOrReturnCtx(e, n)),
              T(n, { code: x.too_small, message: r.message, inclusive: !0, exact: !1, minimum: r.value, type: "date" }),
              t.dirty())
            : r.kind === "max"
              ? e.data.getTime() > r.value &&
                ((n = this._getOrReturnCtx(e, n)),
                T(n, { code: x.too_big, message: r.message, inclusive: !0, exact: !1, maximum: r.value, type: "date" }),
                t.dirty())
              : le.assertNever(r);
    ...
    var gt = class extends Q {
      _parse(e) {
        ...
        if (
          ...
          return Promise.all([...t.data].map((l, o) => r.type._parseAsync(new Et(t, l, t.path, o)))).then((l) =>
            Ze.mergeArray(n, l),
          );
    ...
    gt.create = (e, t) =>
      new gt({ type: e, minLength: null, maxLength: null, exactLength: null, typeName: D.ZodArray, ...$(t) });
    function hn(e) {
      if (e instanceof be) {
        let t = {};
    ...
    var be = class extends Q {
      ...
      _parse(e) {
        ...
        if (this._def.catchall instanceof Mt) {
          ...
          else if (s === "strict") l.length > 0 && (T(n, { code: x.unrecognized_keys, keys: l }), t.dirty());
    ...
    be.create = (e, t) =>
      new be({ shape: () => e, unknownKeys: "strip", catchall: Mt.create(), typeName: D.ZodObject, ...$(t) });
    be.strictCreate = (e, t) =>
      new be({ shape: () => e, unknownKeys: "strict", catchall: Mt.create(), typeName: D.ZodObject, ...$(t) });
    be.lazycreate = (e, t) =>
      new be({ shape: e, unknownKeys: "strip", catchall: Mt.create(), typeName: D.ZodObject, ...$(t) });
      ...
      Zl = class extends Q {
        _parse(e) {
          ...
          return i
            ...
            : (T(t, { code: x.invalid_union_discriminator, options: Array.from(this.optionsMap.keys()), path: [n] }),
              z);
        }
        get discriminator() {
        ...
        static create(e, t, n) {
          ...
          return new Zl({ typeName: D.ZodDiscriminatedUnion, discriminator: e, options: t, optionsMap: r, ...$(n) });
        }
      };
    function tl(e, t) {
      let n = Lt(e),
    ...
    var At = class extends Q {
      _parse(e) {
        ...
        if (n.data.length < this._def.items.length)
          return (
            T(n, { code: x.too_small, minimum: this._def.items.length, inclusive: !0, exact: !1, type: "array" }), z
          );
        !this._def.rest &&
          n.data.length > this._def.items.length &&
          (T(n, { code: x.too_big, maximum: this._def.items.length, inclusive: !0, exact: !1, type: "array" }),
          t.dirty());
        let r = [...n.data]
          .map((i, l) => {
    ...
    var fr = class extends Q {
        ...
        _parse(e) {
          ...
          for (let o in n.data)
            r.push({ key: i._parse(new Et(n, o, n.path, o)), value: l._parse(new Et(n, n.data[o], n.path, o)) });
      ...
      gr = class extends Q {
        ...
        _parse(e) {
          let { status: t, ctx: n } = this._processInputParams(e);
          if (n.parsedType !== M.map) return T(n, { code: x.invalid_type, expected: M.map, received: n.parsedType }), z;
    ...
    var Sn = class extends Q {
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e);
        if (n.parsedType !== M.set) return T(n, { code: x.invalid_type, expected: M.set, received: n.parsedType }), z;
        let r = this._def;
        r.minSize !== null &&
    ...
    Sn.create = (e, t) => new Sn({ valueType: e, minSize: null, maxSize: null, typeName: D.ZodSet, ...$(t) });
    ...
    var en = class extends Q {
      _parse(e) {
        if (typeof e.data != "string") {
          let t = this._getOrReturnCtx(e),
            n = this._def.values;
          return T(t, { expected: le.joinValues(n), received: t.parsedType, code: x.invalid_type }), z;
        }
    ...
    var fa = class extends Q {
      _parse(e) {
        ...
        if (n.parsedType !== M.string && n.parsedType !== M.number) {
          ...
          return T(n, { expected: le.joinValues(r), received: n.parsedType, code: x.invalid_type }), z;
        }
    ...
    var xn = class extends Q {
      ...
      _parse(e) {
        ...
        return Be(n.then((r) => this._def.type.parseAsync(r, { path: t.path, errorMap: t.common.contextualErrorMap })));
      }
    };
        ...
        if (r.type === "transform")
          if (n.common.async === !1) {
            ...
            return this._def.schema
              ._parseAsync({ data: n.data, path: n.path, parent: n })
              .then((l) =>
                oa(l) ? Promise.resolve(r.transform(l.value, i)).then((o) => ({ status: t.value, value: o })) : l,
              );
        le.assertNever(r);
      }
    };
    ...
    rt.createWithPreprocess = (e, t, n) =>
      new rt({ schema: t, effect: { type: "preprocess", transform: e }, typeName: D.ZodEffects, ...$(n) });
...
`),
      _p = ({ onBack: e, hasProjectId: t, setAccessToken: n, setCreatedProjectId: r, exchangeParameters: i }) => {
        let l = kl(),
          o = $s(),
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(ce, { variant: "solid", size: "medium", onClick: () => f(c) }, "Go to Chromatic"),
              ),
            ),
          )
        );
      ...
      Fp = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        ...
        if (r === "welcome" && !n) return a.createElement(Tp, { onNext: () => i("signin"), onUninstall: c });
              ...
              r?.project &&
                a.createElement(
                  ...
                  a.createElement(
                    yt,
                    null,
                    a.createElement(ce, { variant: "solid", size: "medium", onClick: () => n() }, "Catch a UI change"),
                    a.createElement(
                      Ip,
      ...
      var i = r.reduce(function (s, c) {
        ...
        return d
          ? s.concat(
              d.map(function (m) {
                var u, p;
                return (p = (u = m.match(/[\t ]/g)) === null || u === void 0 ? void 0 : u.length) !== null &&
                  p !== void 0
                  ? p
                  : 0;
              }),
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(Ie, { secondary: !0, withArrow: !0, target: "_blank", href: Dp }, "What's this for?"),
            ),
          ),
        )
      );
...
`),
      zp = ({ createdProjectId: e, setCreatedProjectId: t, onUpdateProject: n }) => {
        ...
        return a.createElement(Wp, { createdProjectId: e, setCreatedProjectId: t, onSelectProjectId: r });
      },
      Pa = w.div(({ theme: e }) => ({
      ...
      e1 = w.div(({ theme: e }) => ({})),
      t1 = w.div(({ theme: e }) => ({ background: e.base === "light" ? e.color.lighter : e.color.darker })),
      n1 = w.div(({ theme: e }) => ({
        background: e.base === "light" ? e.color.lightest : e.color.darkest,
        borderRadius: 5,
        border: `1px solid ${e.appBorderColor}`,
                    ...
                    a.createElement(
                      ...
                      d &&
                        a.createElement(tt, {
                          ...
                          title: a.createElement(Ie, { isButton: !0, withArrow: !0 }, "Create new project"),
                        }),
                      d?.projects?.map(
                        (h) =>
                          h &&
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(j, { center: !0, muted: !0 }, "Update your project settings to enable visual testing."),
              ),
              a.createElement(
                ce,
                { asChild: !0, size: "medium", variant: "solid" },
    ...
    A.domElement = (e) =>
      A.object(e) && !A.plainObject(e) && e.nodeType === 1 && A.string(e.nodeName) && m3.every((t) => t in e);
    A.empty = (e) =>
    ...
    function br(e, t) {
      ...
      if (![e, t].every((n) => F.plainObject(n) || F.array(n))) throw new Error("Expected plain objects or array");
      return {
        added: (n, r) => {
          try {
    ...
    function Nn(e) {
      ...
      for (var t = Fn(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling; )
    ...
    function Vl(e, t) {
      ...
      var u = Pt({ top: l.top - o.top - d, left: l.left - o.left - m, width: l.width, height: l.height });
    ...
    function S0(e, t, n) {
      ...
      var r = C0(e),
        ...
        c = l ? "height" : "width",
        d = l ? "width" : "height";
      return (i[o] = t[o] + t[c] / 2 - r[c] / 2), n === s ? (i[s] = t[s] - r[d]) : (i[s] = t[wr(s)]), i;
    }
    function Sa(e, t) {
    ...
    function x0(e, t, n) {
      ...
      return (
        r.forEach(function (i) {
          ...
          i.enabled &&
            g0(l) &&
            ((t.offsets.popper = Pt(t.offsets.popper)), (t.offsets.reference = Pt(t.offsets.reference)), (t = l(t, i)));
        }),
        t
      );
    }
    function F3() {
      if (!this.state.isDestroyed) {
        ...
        (e.offsets.reference = w0(this.state, this.popper, this.reference, this.options.positionFixed)),
          (e.placement = k0(
    ...
    function L3(e, t, n, r) {
      ...
      var i = Ca(e);
      return A0(i, "scroll", n.updateBound, n.scrollParents), (n.scrollElement = i), (n.eventsEnabled = !0), n;
    }
    function R3() {
      this.state.eventsEnabled || (this.state = L3(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function I3(e, t) {
      return (
    ...
    function rl(e, t) {
      Object.keys(t).forEach(function (n) {
        var r = "";
        ["width", "height", "top", "right", "bottom", "left"].indexOf(n) !== -1 && jl(t[n]) && (r = "px"),
          (e.style[n] = t[n] + r);
      });
    }
    function B3(e, t) {
    ...
    function V3(e, t, n, r, i) {
      ...
      return t.setAttribute("x-placement", o), rl(t, { position: n.positionFixed ? "fixed" : "absolute" }), n;
    }
    function D3(e, t) {
      var n = e.offsets,
        r = n.popper,
        ...
        g = t ? (m || u || p ? l : o) : s,
        y = t ? l : s;
      return { left: g(f && !u && t ? r.left - 1 : r.left), top: y(r.top), bottom: y(r.bottom), right: g(r.right) };
    }
    ...
    function j3(e, t) {
      ...
      if (
        ...
        (d[f] = "translate3d(" + g + "px, " + y + "px, 0)"), (d[u] = 0), (d[p] = 0), (d.willChange = "transform");
      else {
        var k = u === "bottom" ? -1 : 1,
          E = p === "right" ? -1 : 1;
    ...
    function $3(e, t) {
      if (N0(e.instance.modifiers, "inner") || (e.flipped && e.placement === e.originalPlacement)) return e;
      var n = Dl(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
      ...
      return (
        o.forEach(function (s, c) {
          ...
          var d = e.offsets.popper,
            ...
            E = (r === "left" && f) || (r === "right" && g) || (r === "top" && y) || (r === "bottom" && k),
          ...
          (p || E || C) &&
            ...
            C && (l = U3(l)),
            (e.placement = r + (l ? "-" + l : "")),
            (e.offsets.popper = Ke({}, e.offsets.popper, S0(e.instance.popper, e.offsets.reference, e.placement))),
    ...
    var eh = {
        ...
        computeStyle: { order: 850, enabled: !0, fn: j3, gpuAcceleration: !0, x: "bottom", y: "right" },
        ...
        function e(t, n) {
          ...
          N3(this, e),
            ...
            Object.keys(Ke({}, e.Defaults.modifiers, i.modifiers)).forEach(function (o) {
              r.options.modifiers[o] = Ke({}, e.Defaults.modifiers[o] || {}, i.modifiers ? i.modifiers[o] : {});
            }),
    ...
    function Na(e, t, n) {
      return t && x1(e.prototype, t), n && x1(e, n), Object.defineProperty(e, "prototype", { writable: !1 }), e;
    }
    function Te(e, t, n) {
      return (
        (t = R0(t)),
    ...
    var wh = { flip: { padding: 20 }, preventOverflow: { padding: 10 } },
      Ch = "The typeValidator argument must be a function with the signature function(props, propName, componentName).",
    ...
    var te = { INIT: "init", IDLE: "idle", OPENING: "opening", OPEN: "open", CLOSING: "closing", ERROR: "error" },
    ...
    function P0(e) {
      ...
      return (
        ...
        (o || l) && !R.boolean(i) && (d.close = a.createElement(B0, { styles: c.close, handleClick: r })),
        a.createElement(
          "div",
          ...
          return (
            ...
            Te(St(i), "handleMouseEnter", function () {
              ...
              if (!(R.boolean(s) || Ci())) {
                ...
                i.event === "hover" &&
                  c === te.IDLE &&
                  (Ha({ title: "mouseEnter", data: [{ key: "originalEvent", value: o }], debug: i.debug }),
            ...
            Te(St(i), "handleMouseLeave", function () {
              ...
              if (!(R.boolean(c) || Ci())) {
                var d = i.state,
                  ...
                  u = d.positionWrapper;
                i.event === "hover" &&
                  (Ha({ title: "mouseLeave", data: [{ key: "originalEvent", value: o }], debug: i.debug }),
                  s
          ...
          Na(n, [
              ...
              value: function () {
                ...
                if (u === "center") this.setState({ status: te.IDLE });
                  ...
                  new g1(i, this.floaterRef, {
                    ...
                    onCreate: function (b) {
                      var C;
                      if (((r.popper = b), !((C = r.floaterRef) !== null && C !== void 0 && C.isConnected))) {
                        r.setState({ needsUpdate: !0 });
                        return;
                      }
                      c(b, "floater"),
                        r._isMounted && r.setState({ currentPlacement: b.placement, status: te.IDLE }),
                        u !== b.placement &&
                          setTimeout(function () {
                            b.instance.update();
                          }, 1);
                    ...
                    onUpdate: function (b) {
                      ...
                      r._isMounted && b.placement !== C && r.setState({ currentPlacement: b.placement });
                    },
                  });
                }
                if (l) {
            ...
            },
            {
              ...
              get: function () {
                ...
                return r ? (R.domElement(r) ? r : document.querySelector(r)) : this.childRef || this.wrapperRef;
              },
            },
            {
              key: "render",
    ...
    var Bh = et(l5(), 1),
      ...
      Vh = (e, t, n) => (t in e ? Ph(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)),
      ...
      q = { INIT: "init", READY: "ready", BEACON: "beacon", TOOLTIP: "tooltip", COMPLETE: "complete", ERROR: "error" },
      K = {
        IDLE: "idle",
        READY: "ready",
        WAITING: "waiting",
    ...
    function va(e, t = "fixed") {
      ...
      let { nodeName: n } = e,
        r = Hh(e);
      return n === "BODY" || n === "HTML" ? !1 : r && r.position === t ? !0 : e.parentNode ? va(e.parentNode, t) : !1;
    }
    function zh(e) {
      var t;
      if (!e) return !1;
    ...
    function Uh(e, t, n) {
      ...
      return (
        l instanceof HTMLElement &&
          ((s = l.scrollTop), !o && !va(e) && (c += s), l.isSameNode(Yt()) || (c += Yt().scrollTop)),
        Math.floor(c - t)
      );
    }
    function $h(e, t, n) {
      ...
      t &&
        (n && e
          ? (console.groupCollapsed(`%creact-joyride: ${n}`, "color: #ff0044; font-weight: bold; font-size: 12px;"),
            Array.isArray(e)
              ? e.forEach((l) => {
                  F.plainObject(l) && l.key ? i.apply(console, [l.key, l.value]) : i.apply(console, [l]);
                })
              : i.apply(console, [e]),
            console.groupEnd())
    ...
    var Qh = {
      ...
      z0 = { back: "Back", close: "Close", last: "Last", next: "Next", open: "Open the dialog", skip: "Skip" },
      Kh = {
        event: "click",
        placement: "bottom",
        offset: 10,
    ...
    function e7(e, t) {
      ...
      let l = { bottom: 0, left: 0, overflow: "hidden", position: "absolute", right: 0, top: 0, zIndex: r.zIndex },
        o = {
          ...
          spotlightLegacy: { ...T1, boxShadow: `0 0 0 9999px ${r.overlayColor}, ${r.spotlightShadow}` },
    ...
    function $n(e, t) {
      ...
      let c = e ?? {},
        ...
        p = Da.default.all([Qh, (n = t.floaterProps) != null ? n : {}, (r = d.floaterProps) != null ? r : {}]);
      return (
        (p.offset = d.offset),
    ...
    function U0(e, t = !1) {
      return F.plainObject(e)
        ? e.target
          ? !0
          : (nn({ title: "validateStep", data: "target is missing from the step", warn: !0, debug: t }), !1)
        ...
        constructor(e) {
          L(this, "beaconPopper"),
            ...
            L(this, "setSteps", (i) => {
              ...
              this.data.set("steps", i), o === K.WAITING && !l && i.length && (s.status = K.RUNNING), this.setState(s);
            }),
            ...
            L(this, "close", () => {
              ...
              l === K.RUNNING && this.setState({ ...this.getNextState({ action: de.CLOSE, index: i + 1 }) });
            }),
            L(this, "go", (i) => {
              let { controlled: l, status: o } = this.getState();
              if (l || o !== K.RUNNING) return;
              let s = this.getSteps()[i];
              this.setState({ ...this.getNextState({ action: de.GO, index: i }), status: s ? o : K.FINISHED });
            }),
            ...
            L(this, "open", () => {
              ...
              i === K.RUNNING && this.setState({ ...this.getNextState({ action: de.UPDATE, lifecycle: q.TOOLTIP }) });
            }),
            L(this, "prev", () => {
              let { index: i, status: l } = this.getState();
              l === K.RUNNING && this.setState({ ...this.getNextState({ action: de.PREV, index: i - 1 }) });
            }),
            L(this, "reset", (i = !1) => {
            ...
            L(this, "skip", () => {
              let { status: i } = this.getState();
              i === K.RUNNING && this.setState({ action: de.SKIP, lifecycle: q.INIT, status: K.SKIPPED });
            }),
            L(this, "start", (i) => {
            ...
            L(this, "stop", (i = !1) => {
              ...
              [K.FINISHED, K.SKIPPED].includes(o) ||
                this.setState({ ...this.getNextState({ action: de.STOP, index: l + (i ? 1 : 0) }), status: K.PAUSED });
            }),
            L(this, "update", (i) => {
              var l;
              if (!Gh(i, O1)) throw new Error(`State is not valid. Valid keys: ${O1.join(", ")}`);
              this.setState({
                ...this.getNextState({ ...this.getState(), ...i, action: (l = i.action) != null ? l : de.UPDATE }, !0),
              });
            });
    ...
    var s7 = o7,
      c7 = class extends jt {
        ...
        render() {
          ...
          let d = { cursor: r ? "default" : "pointer", height: Dh(), pointerEvents: e ? "none" : "auto", ...c },
    ...
    function p7(e) {
      let {
        ...
        G = { primary: C };
      return (
        r && ((G.primary = l ? O : I), k && (G.primary = S("span", null, G.primary, " (", i + 1, "/", s, ")"))),
        E &&
          !l &&
          (G.skip = S(
            "button",
        ...
        !p &&
          i > 0 &&
          (G.back = S("button", { "data-test-id": "button-back", style: h.buttonBack, type: "button", ...t }, b)),
        ...
        S(
          ...
          !g &&
            S(
              ...
              G.back,
              S("button", { "data-test-id": "button-primary", style: h.buttonNext, type: "button", ...o }, G.primary),
            ),
          G.close,
        )
      );
      ...
      f7 = class extends jt {
        ...
        render() {
          ...
          if (s) {
            ...
            d = S(s, { ...m });
          } else d = S(h7, { ...this.getElementsProps(), continuous: e, index: t, isLastStep: n, size: i, step: l });
          return d;
        }
      },
      g7 = class extends jt {
          ...
          super(...arguments),
            ...
            L(this, "setPopper", (e, t) => {
              ...
              t === "wrapper" ? l.setPopper("beacon", e) : l.setPopper("tooltip", e),
                l.getPopper("beacon") && l.getPopper("tooltip") && l.update({ action: r, lifecycle: q.READY }),
        ...
        componentDidUpdate(e) {
          ...
          let {
            ...
            b = l && s === e.index;
          if (
            (v && (h || b) && r({ ...y, index: e.index, lifecycle: q.COMPLETE, step: e.step, type: nt.STEP_AFTER }),
            u.placement === "center" &&
              m === K.RUNNING &&
              f("index") &&
              n !== de.START &&
          ...
          g("lifecycle", q.INIT, q.READY) && p.update({ lifecycle: A1(u) || k ? q.TOOLTIP : q.BEACON }),
            f("index") && nn({ title: `step:${c}`, data: [{ key: "props", value: this.props }], debug: o }),
            f("lifecycle", q.BEACON) && r({ ...y, step: u, type: nt.BEACON }),
            f("lifecycle", q.TOOLTIP) &&
              (r({ ...y, step: u, type: nt.TOOLTIP }),
              this.tooltip &&
                ((this.scope = new i7(this.tooltip, { selector: "[data-action=primary]" })), this.scope.setFocus())),
      ...
      $0 = class extends jt {
          ...
          super(e),
            ...
            L(this, "handleKeyboard", (o) => {
              let { index: s, lifecycle: c } = this.state,
                { steps: d } = this.props,
                m = d[s];
              c === q.TOOLTIP && o.code === "Escape" && m && !m.disableCloseOnEsc && this.store.close();
            }),
            L(this, "syncState", (o) => {
              this.setState(o);
            });
          let { debug: t, getHelpers: n, run: r, stepIndex: i } = e;
          (this.store = r7({ ...e, controlled: r && F.number(i) })), (this.helpers = this.store.getHelpers());
        ...
        componentDidMount() {
          ...
          let { debug: e, disableCloseOnEsc: t, run: n, steps: r } = this.props,
            { start: i } = this.store;
          F1(r, e) && n && i(), t || document.body.addEventListener("keydown", this.handleKeyboard, { passive: !0 });
        }
        componentDidUpdate(e, t) {
          ...
          let { action: n, controlled: r, index: i, lifecycle: l, status: o } = this.state,
            ...
            U = Bt(C.target);
          if ((O && (F1(m, s) ? g(m) : console.warn("Steps are not valid", m)), h("run") && (c ? y(d) : k()), I)) {
          ...
          !r &&
            ...
            i === 0 &&
            !U &&
            (this.store.update({ index: i + 1 }), this.callback({ ...this.state, type: nt.TARGET_NOT_FOUND, step: C }));
          ...
          if (v("action", [de.NEXT, de.PREV, de.SKIP, de.CLOSE]) && v("status", K.PAUSED)) {
            ...
            this.callback({ ...G, index: t.index, lifecycle: q.COMPLETE, step: oe, type: nt.STEP_AFTER });
          }
          if (v("status", [K.FINISHED, K.SKIPPED])) {
            let oe = $n(m[t.index], this.props);
            r || this.callback({ ...G, index: t.index, lifecycle: q.COMPLETE, step: oe, type: nt.STEP_AFTER }),
            ...
            b("status", [K.IDLE, K.READY], K.RUNNING)
              ...
              : (v("status") || v("action", de.RESET)) && this.callback({ ...G, type: nt.TOUR_STATUS });
          this.scrollToStep(t),
            C.placement === "center" && o === K.RUNNING && l === q.INIT && this.store.update({ lifecycle: q.READY });
        }
        componentWillUnmount() {
    ...
    L($0, "defaultProps", Jh);
    var v7 = $0,
      L1 = [void 0, "EQUAL", "FIXED", "ADDED", "CHANGED", "REMOVED", "CAPTURE_ERROR", "SYSTEM_ERROR"],
    ...
    function $l(e) {
      let {
          ...
          (u, p) => (
            ...
            p.result && ["CAPTURE_ERROR", "SYSTEM_ERROR"].includes(p.result) && (u.brokenCount += 1),
        ...
        c = e.length ? Object.fromEntries(e[0].comparisons.map((u) => [u.browser.id, u.browser])) : {},
        d = Object.entries(l).map(([u, p]) => ({ browser: c[u], result: p })),
        m = Object.entries(o).map(([u, p]) => ({ mode: s[u], result: p }));
      return { status: y7(t), isInProgress: n, changeCount: r, brokenCount: i, browserResults: d, modeResults: m };
    }
    var E7 = (e) => {
        try {
          return [Ql()[0][e], Yl()[e]];
    ...
    function w7(e) {
      ...
      return (
        e.length &&
          ...
          (d = t ? k7(c.comparisons, o) : c?.comparisons.find(({ browser: m }) => m.id === o) || c?.comparisons[0]),
...
`),
      _7 = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        ...
        let c = o && t && o.variables.storyId !== t,
          ...
          m = [...yn(N7, d && "testsForStory" in d && d.testsForStory ? d.testsForStory.nodes : [])],
    ...
    var I7 = w.div(({ theme: e }) => ({
      ...
      B7 = w.div(({ theme: e }) => ({ fontSize: 13, lineHeight: "18px", fontWeight: 700, color: e.color.defaultText })),
      P7 = w.div(({ theme: e }) => ({
        fontSize: 13,
        lineHeight: "18px",
        textAlign: "start",
          ...
          X(() => {
            let y = document.getElementById("storybook-explorer-tree"),
              k = Array.from(y instanceof HTMLElement ? y.children : [])
                ...
                .slice(1);
            return k.forEach((E) => (E.style.display = "none")), () => k.forEach((E) => (E.style.display = ""));
          }, []),
          X(() => {
            let y = () => {
              f(1),
    ...
    var $7 =
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement("img", { src: W7, alt: "Color Palette", style: { width: 32, height: 32 } }),
                  "Shift the color palette",
                ),
                a.createElement(
                  Qn,
                  { style: { margin: 0, alignItems: "center", gap: "10px" } },
                  a.createElement("img", { src: G7, alt: "Embiggen", style: { width: 32, height: 32 } }),
                  " ",
                  "Embiggen the type",
                ),
                a.createElement(
      ...
      X7 = ({ isRunning: e, setRunningSecondBuild: t, startBuild: n, setInitialGitHash: r, uncommittedHash: i }) =>
        a.createElement(
          ve,
          { footer: null },
          a.createElement(
            ...
            n
              ? a.createElement(
                  ...
                  a.createElement(
                    ...
                    r.selectedComparison?.headCapture?.captureImage &&
                      a.createElement(sl, { ...r.selectedComparison?.headCapture?.captureImage, status: "positive" }),
                  ),
                  a.createElement(
                    yt,
                    null,
              ...
              : a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(ce, { variant: "solid", size: "medium", onClick: e }, "Take a tour"),
                    a.createElement(ce, { link: !0, onClick: t }, "Skip walkthrough"),
                  ),
                ),
          ),
      ...
      r6 = ({ isRunning: e, localBuildProgress: t, startBuild: n, onSkip: r }) => (
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            null,
            t
              ? a.createElement(se, null, a.createElement(B1, null), a.createElement(zr, { localBuildProgress: t }))
              : a.createElement(
                  se,
                  null,
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                n?.selectedComparison?.headCapture?.captureImage &&
                  a.createElement(sl, { ...n?.selectedComparison?.headCapture.captureImage, status: "positive" }),
              ),
              a.createElement(
                yt,
                null,
                a.createElement(i6, { muted: !0 }, "Let's see the superpower of catching visual changes."),
                a.createElement(ce, { variant: "solid", size: "medium", onClick: e }, "Catch a UI change"),
                a.createElement(ce, { link: !0, onClick: t }, "Skip walkthrough"),
              ),
            ),
          ),
        ...
        if (n) {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(za, null, a.createElement(Ml, { localBuildProgress: n, withEmoji: !0 })),
              m
                ? a.createElement(Je, { onClick: t }, a.createElement(fl, { "aria-label": "Dismiss" }))
                : a.createElement(Je, { as: "div" }, l ? a.createElement(eu, null) : a.createElement(X5, null)),
            ),
      ...
      M6 = ({ isAccepted: e, selectedBrowser: t, browserResults: n, onSelectBrowser: r }) => {
        ...
        return a.createElement(
          we,
          {
            ...
            placement: "top",
            trigger: "hover",
            tooltip: a.createElement(_e, { note: o ? "Switch browser" : `Tested in ${n[0].browser.name}` }),
          },
          o
            ? a.createElement(
                ia,
      ...
      T6 = ({ isAccepted: e, modeOrder: t, modeResults: n, onSelectMode: r, selectedMode: i }) => {
        ...
        return a.createElement(
          we,
          {
            ...
            placement: "top",
            trigger: "hover",
            tooltip: a.createElement(_e, { note: s ? "Switch mode" : `View mode: ${n[0].mode.name}` }),
          },
          s
            ? a.createElement(
                _6,
        ...
        n === "outline"
          ...
          : t === "positive"
            ? {
                ...
                "&:hover": { color: e.color.positiveText, backgroundColor: Gt(0.05, e.background.positive) },
              }
            : t === "warning"
              ? {
                  color: e.color.warningText,
                  ...
                  "&:hover": { color: e.color.warningText, backgroundColor: Gt(0.05, e.background.warning) },
                }
              : {
                  color: e.color.lightest,
                  backgroundColor: e.color.secondary,
                  borderWidth: 0,
                  borderColor: e.base === "light" ? qa(0.2, e.color.secondary) : Gt(0.1, e.color.secondary),
                  "&:hover": { color: e.color.lightest, backgroundColor: Gt(0.05, e.color.secondary) },
                },
      fn = w(Je)(
        ({ square: e }) => ({
      ...
      xi = w.div(({ theme: e, width: t = 14, height: n = 14, marginLeft: r = 7, marginRight: i = 8 }) => ({
        display: "inline-block",
      ...
      L6 = w.div(({ theme: e }) => ({ padding: 9, "> svg": { display: "block" }, path: { fill: e.color.mediumdark } })),
      ...
      I6 = ({ isOutdated: e }) => {
        let { baselineImageVisible: t, diffVisible: n, focusVisible: r } = Lr(),
          ...
          { isReviewing: g, buildIsReviewable: y, userCanReview: k, acceptTest: E, unacceptTest: h } = X0();
        if (f)
          return a.createElement(
            W1,
            null,
          ...
          C &&
            a.createElement(
              ...
              a.createElement(
                we,
                {
                  tooltip: a.createElement(_e, { note: t ? "Show latest snapshot" : "Show baseline snapshot" }),
                  trigger: "hover",
                  hasChrome: !1,
                },
                a.createElement(
            ...
            a.createElement(
              ...
              k &&
                ...
                a.createElement(
                  ...
                  a.createElement(
                    we,
                    { tooltip: a.createElement(_e, { note: "Accept this story" }), trigger: "hover", hasChrome: !1 },
                    a.createElement(
                      fn,
                      {
                  ...
                  a.createElement(
                    we,
                    { tooltip: a.createElement(_e, { note: "Batch accept options" }), trigger: "hover", hasChrome: !1 },
                    a.createElement(
                      ia,
                      {
                        placement: "bottom",
                      ...
                      (O) =>
                        a.createElement(
                          fn,
                          { square: !0, active: O, disabled: g, "aria-label": "Batch accept options", side: "right" },
                          g ? a.createElement(xr, { parentComponent: "IconButton" }) : a.createElement(wo, null),
                        ),
                    ),
                  ),
                ),
              k &&
                ...
                a.createElement(
                  ...
                  a.createElement(
                    we,
                    { tooltip: a.createElement(_e, { note: "Unaccept this story" }), trigger: "hover", hasChrome: !1 },
                    a.createElement(
                      fn,
                      {
                        id: "button-toggle-accept-story",
              ...
              !(k && y) &&
                a.createElement(
                  we,
                  { tooltip: a.createElement(_e, { note: "Reviewing disabled" }), trigger: "hover", hasChrome: !1 },
    ...
    var U6 = { full: "EEEE, MMMM do, y", long: "MMMM do, y", medium: "MMM d, y", short: "MM/dd/yyyy" },
    ...
    var J6 = { narrow: ["B", "A"], abbreviated: ["BC", "AD"], wide: ["Before Christ", "Anno Domini"] },
      X6 = {
        narrow: ["1", "2", "3", "4"],
      ...
      lf = {
        ...
        dayPeriod: Wn({ values: nf, defaultWidth: "wide", formattingValues: af, defaultFormattingWidth: "wide" }),
      },
      of = lf;
    function Gn(e) {
      return function (t) {
    ...
    var uf = /^(\d+)(th|st|nd|rd)?/i,
      ...
      Cf = {
        ...
        era: Gn({ matchPatterns: pf, defaultMatchWidth: "wide", parsePatterns: hf, defaultParseWidth: "any" }),
        quarter: Gn({
          matchPatterns: ff,
        ...
        month: Gn({ matchPatterns: vf, defaultMatchWidth: "wide", parsePatterns: yf, defaultParseWidth: "any" }),
        day: Gn({ matchPatterns: Ef, defaultMatchWidth: "wide", parsePatterns: bf, defaultParseWidth: "any" }),
        dayPeriod: Gn({ matchPatterns: kf, defaultMatchWidth: "any", parsePatterns: wf, defaultParseWidth: "any" }),
      },
      Sf = Cf,
      xf = {
        code: "en-US",
    ...
    function Af(e, t, n) {
      ...
      Ur(2, arguments);
      var o = V6(),
        s = (r = (i = n?.locale) !== null && i !== void 0 ? i : o.locale) !== null && r !== void 0 ? r : Nf;
      ...
      if (
        ...
        var U = f(E / Y1);
        return U === 12 && h !== "month" ? s.formatDistance("xYears", 1, d) : s.formatDistance("xMonths", U, d);
      } else if (v === "year") {
        var G = f(E / Q1);
          ...
          i
            ...
            : E
              ? (b = a.createElement(
                  qn,
                  null,
                  a.createElement("span", null, a.createElement("b", null, "Build failed"), a.createElement(Z6, null)),
                ...
                : l
                  ...
                  : (b = a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement(B6, { icon: p ? "failed" : d === "PENDING" ? "changed" : "passed" }),
                      ),
                      a.createElement(
                        "small",
                        null,
                        ...
                        !m && n && a.createElement("span", { title: new Date(n).toUTCString() }, "Ran ", y),
                      ),
                    )),
          a.createElement(
            a.Fragment,
  ...
  `,
      ...
      Pf = ({
        ...
        X(() => {
          (E.current !== o || h.current !== y.selectedComparison?.id || v.current !== f.id || O || I || U) &&
            (m(!1), u(!1), p(!1)),
        ...
        return a.createElement(
          J1,
          { hidden: l },
          a.createElement(X1, null, a.createElement(K1, null, G, a.createElement(I6, { isOutdated: e }))),
          a.createElement(
            If,
            null,
    ...
    var Hf = ({
        ...
        let { settingsVisible: o, warningsVisible: s } = Lr(),
          ...
          { lastBuildOnBranch: f, lastBuildOnBranchIsReady: g, lastBuildOnBranchIsSelectable: y } = T7(),
          k = Y0(),
          E = on(),
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(Xn, { grow: !0, hidden: !o }, a.createElement(g6, { onClose: () => c(!1) })),
            a.createElement(Xn, { grow: !0, hidden: !s }, a.createElement(Df, { onClose: () => d(!1) })),
          ),
        );
      },
      _i = w(Ie)(() => ({ marginTop: 5 })),
      jf = ({ queryError: e, hasData: t, hasProject: n, hasSelectedBuild: r, localBuildProgress: i, branch: l }) => {
          ...
          ve,
          {
            footer: a.createElement(
              ...
              a.createElement(
                Xe,
                null,
                t && !e && n && a.createElement(j, { muted: !0, style: { marginLeft: 5 } }, "Waiting for build on ", l),
              ),
              a.createElement(Xe, { push: !0 }, a.createElement(Rr, null)),
            ),
          },
          e?.networkError
            ? a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(ce, { size: "medium", variant: "solid", onClick: () => o(null) }, "Log out"),
                ),
              )
                ...
                ? n
                  ...
                  : a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement(_i, { isButton: !0, onClick: () => o(null), withArrow: !0 }, "Switch account"),
                      ),
                    )
...
`),
          ...
          y = a.useCallback(
            async (h) => {
              ...
              b.searchParams.has("vtaOnboarding") &&
                (b.searchParams.delete("vtaOnboarding"), window.history.replaceState({}, "", b.href));
            },
            [g],
          ),
          k = a.useMemo(
            () =>
              ((e && "testsForStatus" in e && e.testsForStatus?.nodes && yn(G0, e.testsForStatus.nodes)) || []).some(
      ...
      Gf = ({
        ...
        X(() => l(!G), [G, l]);
        let ie = C && "testsForStatus" in C && C.testsForStatus?.nodes && yn(G0, C.testsForStatus.nodes),
          Ge = I && Jp(m, ie || []);
        X(() => {
          o((Tt) => ({ ...zf(Tt), ...Ge }));
        }, [JSON.stringify(Ge), o]),
          X(() => {
            n((Tt) => Xp(Tt, { shouldSwitchToLastBuildOnBranch: I && O, lastBuildOnBranchId: C?.id, storyId: d }));
          }, [I, O, C?.id, n, d]);
      ...
      Qf = ({ active: e, api: t }) => {
        ...
        let [c] = Ee(u5),
          ...
          pe = H((He) => y(g5, He), [y]),
          { isRunning: ie, startBuild: Ge, stopBuild: kt } = Sl({ localBuildProgress: p, accessToken: n }),
          _t = Yf(),
          Pe = (He) =>
            a.createElement(
              p2,
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement("div", { hidden: !e, style: { containerType: "size", height: "100%" } }, He),
                      ),
                    ),
                  ),
                ),
        ...
        if (!n) return Pe(a.createElement(Fp, { setAccessToken: i, setCreatedProjectId: G, hasProjectId: !!h }));
        if (E) return e ? a.createElement(Qi, null) : null;
        if (!h) return Pe(a.createElement(zp, { createdProjectId: U, setCreatedProjectId: G, onUpdateProject: b }));
