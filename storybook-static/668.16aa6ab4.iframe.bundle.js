...
(self.webpackChunktsa_app = self.webpackChunktsa_app || []).push([
  [668],
  {
    "./node_modules/.pnpm/@storybook+addon-a11y@8.6.1_dea84b85c8d6a4b56e95db55d8f25ed9/node_modules/@storybook/addon-a11y/dist/matchers-7Z3WT2CE.mjs":
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var ansi_styles_default = (function assembleStyles() {
            ...
            return (
              ...
              Object.defineProperties(styles, {
                ...
                hexToAnsi256: { value: (hex) => styles.rgbToAnsi256(...styles.hexToRgb(hex)), enumerable: !1 },
                ansi256ToAnsi: {
                  value(code) {
                    if (code < 8) return 30 + code;
                    if (code < 16) return code - 8 + 90;
                    let red, green, blue;
                    if (code >= 232) (red = (10 * (code - 232) + 8) / 255), (green = red), (blue = red);
                    else {
                ...
                hexToAnsi: { value: (hex) => styles.ansi256ToAnsi(styles.hexToAnsi256(hex)), enumerable: !1 },
              }),
              styles
            );
          })(),
          level = (() => {
            ...
            if (globalThis.navigator.userAgentData) {
              let brand = navigator.userAgentData.brands.find(({ brand: brand2 }) => "Chromium" === brand2);
              if (brand && brand.version > 93) return 3;
            }
            return /\b(Chrome|Chromium)\//.test(globalThis.navigator.userAgent) ? 1 : 0;
          })(),
          colorSupport = 0 !== level && { level, hasBasic: !0, has256: level >= 2, has16m: level >= 3 },
        ...
        var mod,
                ...
                get: function assembleStyles2() {
                  ...
                  return (
                    ...
                    Object.defineProperties(styles3, {
                      ...
                      hexToAnsi256: { value: (hex) => styles3.rgbToAnsi256(...styles3.hexToRgb(hex)), enumerable: !1 },
                    }),
                    styles3
                  );
                },
          ...
          require_collections = __commonJS({
            "node_modules/pretty-format/build/collections.js"(exports) {
              Object.defineProperty(exports, "__esModule", { value: !0 }),
                  ...
                  if (!current.done) {
                    ...
                    for (; !current.done; ) {
                      ...
                      (result +=
                        ...
                        (current = iterator.next()),
                        current.done ? config.min || (result += ",") : (result += `,${config.spacingInner}`);
                    }
                ...
                (exports.printListItems = function printListItems(list, config, indentation, depth, refs, printer) {
                  let result = "";
                  if (list.length) {
                    result += config.spacingOuter;
                    let indentationNext = indentation + config.indent;
                    for (let i = 0; i < list.length; i++) {
                      ...
                      i in list && (result += printer(list[i], config, indentationNext, depth, refs)),
                        i < list.length - 1 ? (result += `,${config.spacingInner}`) : config.min || (result += ",");
                    }
                    result += config.spacingOuter + indentation;
                  }
                  return result;
                  ...
                  if (keys.length) {
                    ...
                    for (let i = 0; i < keys.length; i++) {
                      ...
                      (result += `${indentationNext + printer(key, config, indentationNext, depth, refs)}: ${printer(val[key], config, indentationNext, depth, refs)}`),
                        i < keys.length - 1 ? (result += `,${config.spacingInner}`) : config.min || (result += ",");
                    }
                    result += config.spacingOuter + indentation;
                  }
                  return result;
          ...
          require_AsymmetricMatcher = __commonJS({
            "node_modules/pretty-format/build/plugins/AsymmetricMatcher.js"(exports) {
              ...
              var _collections = require_collections(),
                ...
                asymmetricMatcher =
                  "function" == typeof Symbol2 && Symbol2.for ? Symbol2.for("jest.asymmetricMatcher") : 1267621,
              ...
              var _collections = require_collections(),
                ...
                test = (val) => {
                  return (
                    ...
                    ((name = val.constructor.name), -1 !== OBJECT_NAMES.indexOf(name) || ARRAY_REGEXP.test(name))
                  );
                  var name;
                };
              exports.test = test;
            ...
            "node_modules/pretty-format/build/plugins/DOMElement.js"(exports) {
              ...
              var _markup = require_markup(),
                ...
                test = (val) => {
                  ...
                  return (
                    (null == val || null === (_val$constructor = val.constructor) || void 0 === _val$constructor
                      ? void 0
                    ...
                    ((val) => {
                      ...
                      return (
                        (1 === nodeType && (ELEMENT_REGEXP.test(constructorName) || isCustomElement)) ||
                      ...
                      (0, _markup.printProps)(
                        ...
                        nodeIsFragment(node)
                          ...
                          : Array.from(node.attributes).reduce(
                              (props, attribute) => ((props[attribute.name] = attribute.value), props),
                              {},
                            ),
                        config,
          ...
          require_Immutable = __commonJS({
            "node_modules/pretty-format/build/plugins/Immutable.js"(exports) {
              ...
              exports.serialize = serialize;
              var test = (val) =>
                val && (!0 === val["@@__IMMUTABLE_ITERABLE__@@"] || !0 === val["@@__IMMUTABLE_RECORD__@@"]);
              exports.test = test;
              var _default = { serialize, test };
              exports.default = _default;
            },
          ...
          require_ReactTestComponent = __commonJS({
            "node_modules/pretty-format/build/plugins/ReactTestComponent.js"(exports) {
              ...
              var _markup = require_markup(),
                Symbol2 = globalThis["jest-symbol-do-not-touch"] || globalThis.Symbol,
                testSymbol = "function" == typeof Symbol2 && Symbol2.for ? Symbol2.for("react.test.json") : 245830487,
          ...
          require_build = __commonJS({
            "node_modules/pretty-format/build/index.js"(exports) {
              ...
              function printBasicValue(val, printFunctionName, escapeRegex, escapeString) {
                ...
                if ("string" === typeOf) return escapeString ? `"${val.replace(/"|\\/g, "\\$&")}"` : `"${val}"`;
                ...
                return "[object WeakMap]" === toStringed
                  ...
                  : "[object WeakSet]" === toStringed
                    ? "WeakSet {}"
                    : "[object Function]" === toStringed || "[object GeneratorFunction]" === toStringed
              ...
              var getColorsHighlight = (options) =>
                  DEFAULT_THEME_KEYS.reduce((colors, key) => {
                    let value =
                        options.theme && void 0 !== options.theme[key] ? options.theme[key] : DEFAULT_THEME[key],
                ...
                getEscapeRegex = (options) => {
                  ...
                  return null !== (_options$escapeRegex = options?.escapeRegex) && void 0 !== _options$escapeRegex
                    ? _options$escapeRegex
                    : DEFAULT_OPTIONS.escapeRegex;
                },
                getEscapeString = (options) => {
                  var _options$escapeString;
                  return null !== (_options$escapeString = options?.escapeString) && void 0 !== _options$escapeString
                ...
                getConfig = (options) => {
                  ...
                  return {
                    callToJSON:
                      null !== (_options$callToJSON = options?.callToJSON) && void 0 !== _options$callToJSON
                        ? _options$callToJSON
                    ...
                    compareKeys:
                      "function" == typeof options?.compareKeys ? options.compareKeys : DEFAULT_OPTIONS.compareKeys,
              ...
              function format(val, options) {
                ...
                return null !== basicResult ? basicResult : printComplexValue(val, getConfig(options), "", 0, []);
              }
              var plugins = {
        ...
        function stringify(object, maxDepth = 10, maxWidth = 10) {
          let result;
          try {
            result = (0, import_pretty_format.format)(object, { maxDepth, maxWidth, min: !0, plugins: PLUGINS });
          } catch {
                ...
                return (
                  (function matcherHint(matcherName, received = "received", expected = "expected", options = {}) {
                    ...
                    return (
                      !isDirectExpectCall &&
                        "" !== received &&
                        ((hint += DIM_COLOR(`${dimString}(`) + receivedColor(received)), (dimString = ")")),
                      "" !== promise && ((hint += DIM_COLOR(`${dimString}.`) + promise), (dimString = "")),
                      ...
                      "" === expected
                        ...
                        : ((hint += DIM_COLOR(`${dimString}(`) + expectedColor(expected)),
                          secondArgument && (hint += DIM_COLOR(", ") + secondArgumentColor(secondArgument)),
                          (dimString = ")")),
