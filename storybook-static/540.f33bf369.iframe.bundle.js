    ...
    "./node_modules/.pnpm/@radix-ui+react-popper@1.2._a128a11ffd1ff70497f383aa72d4b599/node_modules/@radix-ui/react-popper/dist/index.mjs":
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function floating_ui_utils_rectToClientRect(rect) {
          ...
          return { width, height, top: y, left: x, right: x + width, bottom: y + height, x, y };
        }
        ...
        async function detectOverflow(state, options) {
          ...
          const { x, y, platform, rects, elements, strategy } = state,
            ...
            element =
              elements[altBoundary ? ("floating" === elementContext ? "reference" : "floating") : elementContext],
            ...
            offsetScale = ((await (null == platform.isElement ? void 0 : platform.isElement(offsetParent))) &&
              (await (null == platform.getScale ? void 0 : platform.getScale(offsetParent)))) || { x: 1, y: 1 },
        ...
        function getDocumentElement(node) {
          var _ref;
          return null == (_ref = (isNode(node) ? node.ownerDocument : node.document) || window.document)
            ? void 0
        ...
        function isContainingBlock(elementOrCss) {
          const webkit = isWebKit(),
            css = isElement(elementOrCss) ? getComputedStyle(elementOrCss) : elementOrCss;
          return (
        ...
        function getOverflowAncestors(node, list, traverseIframes) {
          ...
          const scrollableAncestor = getNearestOverflowAncestor(node),
            isBody =
              scrollableAncestor ===
              (null == (_node$ownerDocument2 = node.ownerDocument) ? void 0 : _node$ownerDocument2.body),
        ...
        function getCssDimensions(element) {
          ...
          return (
            shouldFallback && ((width = offsetWidth), (height = offsetHeight)), { width, height, $: shouldFallback }
          );
        }
        ...
        function getScale(element) {
          ...
          return (x && Number.isFinite(x)) || (x = 1), (y && Number.isFinite(y)) || (y = 1), { x, y };
        }
        ...
        function getBoundingClientRect(element, includeScale, isFixedStrategy, offsetParent) {
          ...
          includeScale &&
            (offsetParent ? isElement(offsetParent) && (scale = getScale(offsetParent)) : (scale = getScale(element)));
          const visualOffsets = (function shouldAddVisualOffsets(element, isFixed, floatingOffsetParent) {
            return (
              void 0 === isFixed && (isFixed = !1),
              !(!floatingOffsetParent || (isFixed && floatingOffsetParent !== getWindow(element))) && isFixed
            );
          ...
          if (domElement) {
            ...
            for (; currentIFrame && offsetParent && offsetWin !== currentWin; ) {
              const iframeScale = getScale(currentIFrame),
                ...
                left = iframeRect.left + (currentIFrame.clientLeft + parseFloat(css.paddingLeft)) * iframeScale.x,
          ...
          if ("viewport" === clippingAncestor)
            ...
            rect = (function getDocumentRect(element) {
              const html = getDocumentElement(element),
                ...
                width = floating_ui_utils_max(html.scrollWidth, html.clientWidth, body.scrollWidth, body.clientWidth),
            ...
            rect = (function getInnerBoundingClientRect(element, strategy) {
              const clientRect = getBoundingClientRect(element, !0, "fixed" === strategy),
                ...
                scale = isHTMLElement(element) ? getScale(element) : createCoords(1);
              return {
        ...
        function hasFixedPositionAncestor(element, stopNode) {
          ...
          return (
            !(parentNode === stopNode || !isElement(parentNode) || isLastTraversableNode(parentNode)) &&
            ("fixed" === getComputedStyle(parentNode).position || hasFixedPositionAncestor(parentNode, stopNode))
          );
        }
        function getRectRelativeToOffsetParent(element, offsetParent, strategy) {
          ...
          if (isOffsetParentAnElement || (!isOffsetParentAnElement && !isFixed))
            if (
              (("body" !== getNodeName(offsetParent) || isOverflowElement(documentElement)) &&
        ...
        function getTrueOffsetParent(element, polyfill) {
          ...
          return (
            getDocumentElement(element) === rawOffsetParent && (rawOffsetParent = rawOffsetParent.ownerDocument.body),
            rawOffsetParent
          );
        }
          ...
          return (
            animationFrame &&
              (function frameLoop() {
                ...
                prevRefRect && !rectsAreEqual(prevRefRect, nextRefRect) && update();
              ...
              void 0 === options && (options = 0),
              {
                ...
                async fn(state) {
                  ...
                  const { x, y, placement, middlewareData } = state,
                    diffCoords = await (async function convertValueToCoords(state, options) {
                      const { placement, platform, elements } = state,
                        rtl = await (null == platform.isRTL ? void 0 : platform.isRTL(elements.floating)),
                        side = floating_ui_utils_getSide(placement),
                        alignment = floating_ui_utils_getAlignment(placement),
                        isVertical = "y" === floating_ui_utils_getSideAxis(placement),
                  ...
                  return placement ===
                    ...
                    ? {}
                    : { x: x + diffCoords.x, y: y + diffCoords.y, data: { ...diffCoords, placement } };
                },
              }
            );
          },
              ...
              void 0 === options && (options = {}),
              {
                ...
                async fn(state) {
                  ...
                  if (checkMainAxis) {
                    ...
                    mainAxisCoord = clamp(
                      mainAxisCoord + overflow["y" === mainAxis ? "top" : "left"],
                      mainAxisCoord,
                  ...
                  if (checkCrossAxis) {
                    ...
                    crossAxisCoord = clamp(
                      crossAxisCoord + overflow["y" === crossAxis ? "top" : "left"],
                      crossAxisCoord,
              ...
              void 0 === options && (options = {}),
              {
                ...
                async fn(state) {
                  ...
                  const side = floating_ui_utils_getSide(placement),
                    initialSideAxis = floating_ui_utils_getSideAxis(initialPlacement),
                    ...
                    hasFallbackAxisSideDirection = "none" !== fallbackAxisSideDirection;
                  !specifiedFallbackPlacements &&
                  ...
                  const placements = [initialPlacement, ...fallbackPlacements],
                    ...
                    overflows = [];
                  let overflowsData =
                    (null == (_middlewareData$flip = middlewareData.flip) ? void 0 : _middlewareData$flip.overflows) ||
                    [];
                  if ((checkMainAxis && overflows.push(overflow[side]), checkCrossAxis)) {
                    const sides = (function floating_ui_utils_getAlignmentSides(placement, rects, rtl) {
                      void 0 === rtl && (rtl = !1);
                      const alignment = floating_ui_utils_getAlignment(placement),
                        alignmentAxis = getAlignmentAxis(placement),
              ...
              void 0 === options && (options = {}),
              {
                ...
                async fn(state) {
                  ...
                  const { placement, rects, platform, elements } = state,
                    { apply = () => {}, ...detectOverflowOptions } = floating_ui_utils_evaluate(options, state),
                    overflow = await detectOverflow(state, detectOverflowOptions),
                    side = floating_ui_utils_getSide(placement),
                    alignment = floating_ui_utils_getAlignment(placement),
                  ...
                  "top" === side || "bottom" === side
                    ? ((heightSide = side),
                      (widthSide =
                        alignment ===
                        ((await (null == platform.isRTL ? void 0 : platform.isRTL(elements.floating)))
                          ? "start"
                          : "end")
                          ? "left"
                          : "right"))
                  ...
                  const maximumClippingHeight = height - overflow.top - overflow.bottom,
                    ...
                    overflowAvailableWidth = floating_ui_utils_min(width - overflow[widthSide], maximumClippingWidth),
                    noShift = !state.middlewareData.shift;
                  let availableHeight = overflowAvailableHeight,
                    availableWidth = overflowAvailableWidth;
                  if (
                    (null != (_state$middlewareData = state.middlewareData.shift) &&
                      _state$middlewareData.enabled.x &&
                      (availableWidth = maximumClippingWidth),
                    null != (_state$middlewareData2 = state.middlewareData.shift) &&
          ...
          floating_ui_dom_hide = function (options) {
            return (
              void 0 === options && (options = {}),
              {
                ...
                async fn(state) {
                  const { rects } = state,
                    { strategy = "referenceHidden", ...detectOverflowOptions } = floating_ui_utils_evaluate(
                      options,
                      state,
                    );
                  switch (strategy) {
                    case "referenceHidden": {
                      const offsets = getSideOffsets(
                        await detectOverflow(state, { ...detectOverflowOptions, elementContext: "reference" }),
                        rects.reference,
                      );
                      return {
                        data: { referenceHiddenOffsets: offsets, referenceHidden: isAnySideFullyClipped(offsets) },
                      };
                    }
                    case "escaped": {
                      const offsets = getSideOffsets(
                        await detectOverflow(state, { ...detectOverflowOptions, altBoundary: !0 }),
                        rects.floating,
                      );
          ...
          floating_ui_dom_arrow = (options) => ({
            ...
            async fn(state) {
              const { x, y, placement, rects, platform, elements, middlewareData } = state,
                { element, padding = 0 } = floating_ui_utils_evaluate(options, state) || {};
              ...
              (clientSize && (await (null == platform.isElement ? void 0 : platform.isElement(arrowOffsetParent)))) ||
                (clientSize = elements.floating[clientProp] || rects.floating[length]);
              const centerToReference = endDiff / 2 - startDiff / 2,
                largestPossiblePadding = clientSize / 2 - arrowDimensions[length] / 2 - 1,
                minPadding = floating_ui_utils_min(paddingObject[minProp], largestPossiblePadding),
                maxPadding = floating_ui_utils_min(paddingObject[maxProp], largestPossiblePadding),
                min$1 = minPadding,
                ...
                fn(state) {
                  ...
                  if (checkCrossAxis) {
                    ...
                    const len = "y" === mainAxis ? "width" : "height",
                      isOriginSide = ["top", "left"].includes(floating_ui_utils_getSide(placement)),
                      limitMin =
                      ...
                      limitMax =
                        ...
                        (isOriginSide
                          ? 0
                          : (null == (_middlewareData$offse2 = middlewareData.offset)
                              ? void 0
        ...
        var react_dom = __webpack_require__(
          ...
          index = "undefined" != typeof document ? react.useLayoutEffect : react.useEffect;
        ...
        const arrow$1 = (options) => ({
            ...
            fn(state) {
              ...
              return element &&
                ...
                ? null != element.current
                  ? floating_ui_dom_arrow({ element: element.current, padding }).fn(state)
                  : {}
                : element
          ...
          floating_ui_react_dom_limitShift = (options, deps) => ({
          ...
          floating_ui_react_dom_size = (options, deps) => ({
            ...floating_ui_dom_size(options),
            options: [options, deps],
          }),
          floating_ui_react_dom_hide = (options, deps) => ({
            ...floating_ui_dom_hide(options),
            options: [options, deps],
          }),
          floating_ui_react_dom_arrow = (options, deps) => ({ ...arrow$1(options), options: [options, deps] });
        var dist = __webpack_require__(
          ...
          Arrow = react.forwardRef((props, forwardedRef) => {
            ...
            return (0, jsx_runtime.jsx)(dist.sG.svg, {
              ...
              children: props.asChild ? children : (0, jsx_runtime.jsx)("polygon", { points: "0,0 30,0 15,10" }),
            });
          });
        ...
        var [createPopperContext, createPopperScope] = (0, react_context_dist.A)("Popper"),
        ...
        var PopperAnchor = react.forwardRef((props, forwardedRef) => {
          ...
          return (
            ...
            virtualRef ? null : (0, jsx_runtime.jsx)(dist.sG.div, { ...anchorProps, ref: composedRefs })
          );
        });
                ...
                return (
                  (0, react_use_layout_effect_dist.N)(() => {
                    if (element) {
                      ...
                      return (
                        resizeObserver.observe(element, { box: "border-box" }), () => resizeObserver.unobserve(element)
                      );
                    }
                    setSize(void 0);
                  }, [element]),
              ...
              { refs, floatingStyles, placement, isPositioned, middlewareData } = (function useFloating(options) {
                  ...
                  update = react.useCallback(() => {
                    ...
                    platformRef.current && (config.platform = platformRef.current),
                      floating_ui_dom_computePosition(referenceRef.current, floatingRef.current, config).then(
                        (data) => {
                          const fullData = { ...data, isPositioned: !1 !== openRef.current };
                ...
                index(() => {
                  !1 === open &&
                    ...
                    ((dataRef.current.isPositioned = !1), setData((data) => ({ ...data, isPositioned: !1 })));
                }, [open]);
                ...
                whileElementsMounted: (...args) =>
                  autoUpdate(...args, { animationFrame: "always" === updatePositionStrategy }),
                elements: { reference: context.anchor },
                middleware: [
                  ((options = { mainAxis: sideOffset + arrowHeight, alignmentAxis: alignOffset }),
                  { ...floating_ui_dom_offset(options), options: [options, deps] }),
                  avoidCollisions &&
                    floating_ui_react_dom_shift({
                      mainAxis: !0,
                      crossAxis: !1,
                      limiter: "partial" === sticky ? floating_ui_react_dom_limitShift() : void 0,
                      ...detectOverflowOptions,
                    }),
        ...
        var OPPOSITE_SIDE = { top: "bottom", right: "left", bottom: "top", left: "right" },
          PopperArrow = react.forwardRef(function PopperArrow2(props, forwardedRef) {
            const { __scopePopper, ...arrowProps } = props,
              contentContext = useContentContext("PopperArrow", __scopePopper),
        ...
        var transformOrigin = (options) => ({
          ...
          fn(data) {
            ...
            return (
              "bottom" === placedSide
                ? ((x = isArrowHidden ? noArrowAlign : `${arrowXCenter}px`), (y = -arrowHeight + "px"))
                : "top" === placedSide
                  ? ((x = isArrowHidden ? noArrowAlign : `${arrowXCenter}px`),
                    (y = `${rects.floating.height + arrowHeight}px`))
                  : "right" === placedSide
                    ? ((x = -arrowHeight + "px"), (y = isArrowHidden ? noArrowAlign : `${arrowYCenter}px`))
                    : "left" === placedSide &&
